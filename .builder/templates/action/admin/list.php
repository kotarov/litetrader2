...
<html class="uk-height-1-1">
    ...
    <body id="page-__partners.MODULE__"> 
        <?php include '../snipps/head.php'; ?>
            
        <h2 class="page-header"><spn data-lang>Orders of __partners.TITLE__</span><span class="uk-margin-left page-sparkline" data-table="customers_orders"></span></h2>
        ...
        <script> 
            $("#orders").DataTable({
            	...
            	ajax: "<?=URL_BASE?>ajax.php?f=__MODULE__/getList",
            	stateSave: true,
            	order: [[ 1, "desc" ]],
            	columns: [
            		...
            		{ data:"partner", title:(lang["__partners.TITLE__"]||"__partners.TITLE__"), render:function(d,t,r){return (r.id_partner>0?d:d+' <small class="uk-badge uk-badge-warning">Unregistered</small> ')} },
            		__DT_PARTNERS_COMPANIES__
            	    ...
            	    { data:"actions", title:"", width:"1em", orderable:false, searchable:false, "class":"uk-text-center uk-text-middle uk-text-nowrap actions",
            			...
            			+'<a href="#modal-edit-order" data-uk-modal class="uk-icon-edit uk-icon-justify" data-get="id='+d+'" data-populate=\'{"id":"'+d+'","partner-photo":"../__partners.MODULE__/image.php/'+r.id_partner+'","company-logo":"../__partners.MODULE__/companies/image.php/'+r.id_company+'"}\' title="Edit"></a>'
        ...
        <?php /*** Modal NEW */ ?>
         <div id="modal-new-order" class="uk-modal" data-hide-on-submit>
            <div class="uk-modal-dialog uk-modal-dialog-medium"> <a class="uk-modal-close uk-close"></a>
                ...
                <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=__MODULE__/post" data-trigger="order-added">
                    
                    <!-- ********* -->
                    <div class="uk-form-row">
                        <label class="uk-form-label"><span class="uk-badge uk-badge-notification">1</span> <span data-lang>__partners.TITLE__</span> </label>
                        <div class="uk-form-controls">
                            <select class="select2 uk-width-1-1" style="width:100%" 
                                name="id_partner" 
                                data-placeholder="UNREGISTERED" data-lang 
                                data-allow-clear= "true" 
                                data-ajax--url="<?=URL_BASE?>ajax.php?f=__MODULE__/searchPartners" 
                                data-templateResult = '<span>
                                        {{id}}. __FORM_PARTNER_PHOTO_RES__ {{text}}
                                ...
                                data-templateSelection = '<span>{{id}}. __FORM_PARTNER_PHOTO_SEL__ {{text}} <small>| <i class="uk-icon-envelope"></i> {{email}} | <i class="uk-icon-phone"></i> {{phone}}</small></span>' 
                            ></select>
                        </div>
                    </div>
                        ...
                        <div class="uk-form-row uk-margin-small-top">
                            ...
                            <div class="uk-form-controls">
                                <select class="select2 uk-width-1-1" style="width:100%" 
                                    ...
                                    data-placeholder="UNREGISTERED" data-lang
                                    data-allow-clear="true" 
                                    data-get="<?=URL_BASE?>ajax.php?f=__MODULE__/getPartnerCompanies"
                    ...
                    <hr>
                        <div class="uk-form-row">
                            ...
                            <div class="uk-form-controls"><input class="uk-width-1-1"
                                ...
                                data-get="<?=URL_BASE?>ajax.php?f=__MODULE__/getPartnerData&field=partner" 
                            ></div>
                            <div class="uk-form-controls">
                                    <label><input type="checkbox" class="toggle-color" name="register-new-partner">  <span data-lang>Create new</span> <span data-lang>__partners.TITLE__</span></label>
                            </div>
                        </div>
                        ...
                        <div class="uk-form-row uk-margin-top">
                            ...
                            <div class="uk-form-controls uk-grid">
                                <input class="uk-width-small-2-3" 
                                    ...
                                    data-depends-on="#modal-new-order [name=id_company],#modal-new-order [name=id_partner]" 
                                    data-get="<?=URL_BASE?>ajax.php?f=__MODULE__/getPartnerData&field=name" 
                                >
                                <input class="uk-width-small-1-3" 
                                    placeholder="EIN" title="EIN" data-lang
                                    name="ein" 
                                    data-depends-on="#modal-new-order [name=id_company],#modal-new-order [name=id_partner]" 
                                    data-get="<?=URL_BASE?>ajax.php?f=__MODULE__/getPartnerData&field=ein" 
                                >
                            </div>
                            <div class="uk-form-controls">
                        ...
                        <div class="uk-form-row">
                            ...
                            <div class="uk-form-controls uk-grid">
                                <input class="uk-width-small-1-2"
                                    ...
                                    data-depends-on="#modal-new-order [name=id_company],#modal-new-order [name=id_partner]"
                                    data-get="<?=URL_BASE?>ajax.php?f=__MODULE__/getPartnerData&field=email" 
                                >
                                <input name="phone" class="uk-width-small-1-2"
                                    placeholder="Phone" title="Phone" data-lang
                                    data-depends-on="#modal-new-order [name=id_company],#modal-new-order [name=id_partner]"
                                    data-get="<?=URL_BASE?>ajax.php?f=__MODULE__/getPartnerData&field=phone" 
                                >
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="uk-form-row">
                            ...
                            <div class="uk-form-controls uk-grid">
                                <input type="text" class="uk-width-small-1-2" data-lang 
                                    ...
                                    data-get1="<?=URL_BASE?>ajax.php?f=__MODULE__/getPartnerData&field=country"
                                    readonly="readonly"
                                    value="България"
                                >
                                ...
                                <select name="city" style="width:100%" class="select2" data-lang
                                    ...
                                    data-get="<?=URL_BASE?>ajax.php?f=__MODULE__/getPartnerData&field=city" 
                                ><?=$cities_opts?></select>
                                </span>
                                ...
                                <input class="uk-width-small-1-1" data-lang 
                                    ...
                                    data-depends-on="#modal-new-order [name=id_company],#modal-new-order [name=id_partner]"
                                    data-get="<?=URL_BASE?>ajax.php?f=__MODULE__/getPartnerData&field=address" 
                                >
                            </div>
                        </div>
                        ...
                        <div class="uk-form-row">
                            ...
                            <div class="uk-form-controls uk-grid">
                                <select type="text"  class="uk-width-small-1-1" data-lang 
                                    name="key_tax"
                                    title="Tax"
                                    data-get="<?=URL_BASE?>ajax.php?f=__MODULE__/taxes/getList"   
                                >
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="uk-form-row">
                            ...
                            <div class="uk-form-controls uk-grid">
                                <select type="text"  class="uk-width-small-1-1" data-lang 
                                    ...
                                    title="Delivery"
                                    data-get="<?=URL_BASE?>ajax.php?f=__MODULE__/deliveries/getList"  
                                >
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="uk-form-row">
                            ...
                            <div class="uk-form-controls uk-grid">
                                <select type="text"  class="uk-width-small-1-1" data-lang 
                                    ...
                                    title="Payment"
                                    data-get="<?=URL_BASE?>ajax.php?f=__MODULE__/payments/getList"   
                                >
                                </select>
                            </div>
                        </div>
        ...
        <?php /*** Modal EDIT */ ?>
         <div id="modal-edit-order" class="uk-modal" data-get="<?=URL_BASE?>ajax.php?f=__MODULE__/getOrder" data-hide-on-submit>
            <div class="uk-modal-dialog uk-modal-dialog-medium"> <a class="uk-modal-close uk-close"></a>
                <div class="uk-modal-header"> <h3><span data-lang>Edit order</span> #<span name="id"></span></h3> </div>
                <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=__MODULE__/post" data-trigger="order-updated">
                    ...
                    <div class="uk-form-row">
                        <label class="uk-form-label"><span data-lang>__partners.TITLE__</span> </label>
                        <div class="uk-form-controls">
                                    ...
                                    <select class="select2 uk-width-1-1" style="width:100%" 
                                        ...
                                        data-templateSelection = '<span>{{id}}. __FORM_PARTNER_PHOTO_SEL__ {{text}}</span>' 
                                    ></select>
                        ...
                        <div class="uk-form-row">
                            ...
                            <div class="uk-form-controls uk-grid">
                                <input type="text"  class="uk-width-small-1-2" data-lang 
                                    ...
                                    placeholder="Country" title="Country"
                                    data-depends-on="#modal-edit-order [name=id_company_change],#modal-edit-order [name=id_company],#modal-edit-order [name=id_partner]"
                                    data-get="<?=URL_BASE?>ajax.php?f=__MODULE__/getPartnerData&field=country"  
                                >
                                <span class="uk-width-small-1-2" style="padding:0">
                                <select name="city" style="width:100%" class="select2" data-lang
                                    title="City"
        ...
        <div id="modal-delete-order" class="uk-modal" data-hide-on-submit>
            <div class="uk-modal-dialog uk-modal-dialog-small">  <a class="uk-modal-close uk-close"></a>
                ...
                <form action="<?=URL_BASE?>ajax.php?f=__MODULE__/postDelete" method="post" data-trigger="order-deleted" data-hide-on-submit>
        ...
        <div id="modal-change-status" class="uk-modal">
            <div class="uk-modal-dialog">  <a class="uk-modal-close uk-close"></a>
                ...
                <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=__MODULE__/postStatus" data-trigger="ordercart-changed,order-updated">
                    <input type="hidden" name="id">                
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            <select class="select2 uk-width-1-1" style="width:100%" 
                                name="id_status"
                                data-get="<?=URL_BASE?>ajax.php?f=__MODULE__/statuses/getList&first=%2B Change status ..." 
                ...
                <table id="list-order-statuses" data-trigger-reload="ordercart-changed" data-get="<?=URL_BASE?>ajax.php?f=__MODULE__/statuses/getHistory" 
        ...
        <div id="modal-cart-order" class="uk-modal">
            <div class="uk-modal-dialog"> <a class="uk-modal-close uk-close"></a>
                ...
                <table id="list-orders-items" data-trigger-reload="order-cart-changed" data-get="<?=URL_BASE?>ajax.php?f=__MODULE__/orders_items/getCart" class="uk-table uk-table-hover uk-table-striped uk-table-condensed" cellspacing="0" width="100%">
                ...
                <script>$("#list-orders-items").DataTable({
                    ...
                    columns: [
                        { data: "image", title:"", orderable:false, sortable:false, render:function(d,t,r){
                            return '<img width="40" src="../__items.MODULE__/image.php/'+d+'/small/'+r['date_add']+'">';
                        }   },
        ...
        <div id="modal-edit-from-cart" class="uk-modal" data-get="<?=URL_BASE?>ajax.php?f=__MODULE__/orders_items/getEditItem" data-hide-on-submit>
            <div class="uk-modal-dialog"> <a class="uk-modal-close uk-close"></a>
                <div class="uk-modal-header"> <h3><span data-lang>Edit item in order</span> #<span name="id_parent"></span></h3> </div>
                <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=__MODULE__/orders_items/postEditItem" data-trigger="order-cart-changed,order-updated">
                        ...
                        <div class="uk-form-controls uk-grid uk-grid-collapse">
                            <div class="uk-width-1-2">
                                <input class="uk-width-1-1" type="text" name="qty"
                                    ...
                                    data-get="<?=URL_BASE?>ajax.php?f=__items.MODULE__/getItem"
                                >
                            </div>
                            <div class="uk-width-1-2">
                                <select class="uk-width-1-1" type="text" name="id_unit" 
                                    data-value-depends-on="#add-to-cart [name=qty]" 
                                    data-get="<?=URL_BASE?>ajax.php?f=__items.MODULE__/units/getUnits"
                                ></select>
                            </div>
                        </div>
                    </div>
        ...
        <div id="add-to-cart" class="uk-modal" data-hide-on-submit>
            <div class="uk-modal-dialog"> <a class="uk-modal-close uk-close"></a>
                ...
                <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=__MODULE__/orders_items/postAppendCart" data-trigger="order-cart-changed,order-updated">
                    <input type="hidden" name="id_parent">
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            <select class="uk-width-1-1 select2" name="id_item" style="width:100%" 
                                data-ajax--url="<?=URL_BASE?>ajax.php?f=__MODULE__/searchItems" 
                                data-templateResult='
                                    <img class="uk-align-left" src="../__items.MODULE__/image.php/{{id}}/small" width="40"> 
                                    <span>{{id}}</span> {{text}} <small class="uk-text-muted">ref: {{reference}}</small>
                                    <div><sup><i>{{category}}</i></sup></div>'
                                data-templateSelection='
                                    <img src="../__items.MODULE__/image.php/{{id}}/small" width="20"> 
                                    <span>{{id}}</span> {{text}}
        ...
        <?php /*** Modal delete from cart */?>
         <div id="modal-delete-from-cart" class="uk-modal" data-hide-on-submit>
            <div class="uk-modal-dialog uk-modal-dialog-small"> <a class="uk-modal-close uk-close"></a>
                ...
                <form action="<?=URL_BASE?>ajax.php?f=__MODULE__/orders_items/postRemove" method="post" data-trigger="order-cart-changed,order-updated">
        ...
        <div id="modal-create-invoice" class="uk-modal" data-hide-on-submit>
            <div class="uk-modal-dialog uk-modal-dialog-small"> <a class="uk-modal-close uk-close"></a>
                ...
                <form action1="<?=URL_BASE?>ajax.php?f=__MODULE__/orders_items/postRemove" method="post" data-trigger="order-updated">
