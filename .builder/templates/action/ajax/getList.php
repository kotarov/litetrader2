...
$sth = $dbh->prepare("SELECT 
    ...
    o.partner,
    o.id_partner,
    __SELECT_PARTNERS_COMPANIES__
    o.city, o.country, o.address,
    (SELECT SUM(oi.price*oi.qty) FROM orders_items oi WHERE oi.id_order = o.id) sum,
    (SELECT SUM(oi.price*oi.qty)+o.delivery_price+o.tax_price FROM orders_items oi WHERE oi.id_order = o.id) total,
    o.invoice,
    o.id actions,
    o.id_partner,
    s.is_closed,
