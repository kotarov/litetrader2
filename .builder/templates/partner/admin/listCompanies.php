...
<html class="uk-height-1-1">
    <head>
        ...
        <title>Companies of __TITLE__</title>
    ...
    <body id="page-__MODULE__"> 
        ...
        <h2 class="page-header" data-lang="Companies of __TITLE__"></h2>
        ...
        <script>$('#companies').DataTable({
        	...
        	ajax: "<?=URL_BASE?>ajax.php?f=__MODULE__/companies/getCompanies",
        	stateSave: true,
        	order: [[ 0, "asc" ]],
            columns: [
        ...
        <?php /*** Modal NEW */ ?>
         <div id="modal-new-company" class="uk-modal" data-hide-on-submit>
            <div class="uk-modal-dialog">
                ...
                <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=__MODULE__/companies/postNew" data-trigger="company-added">
        ...
        <?php /*** Modal EDIT */ ?>
         <div id="modal-edit-company" class="uk-modal" data-get="<?=URL_BASE?>ajax.php?f=__MODULE__/companies/getCompany" data-hide-on-submit>
            <div class="uk-modal-dialog">
                <a class="uk-modal-close uk-close"></a>
                <div class="uk-modal-header"> <h3><span data-lang>Edit company</span> #<span class="uk-text-muted" name="id"></span></h3> </div>
                <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=__MODULE__/companies/postEdit" data-trigger="company-updated">
        ...
        <div id="modal-company-employees" class="uk-modal">
            <div class="uk-modal-dialog"> <a class="uk-modal-close uk-close"></a>
                ...
                <table id="list-company-employees" cellspacing="0" width="100%" 
                    ...
                    data-get="<?=URL_BASE?>ajax.php?f=__MODULE__/companies_employees/getList" 
                    class="uk-table uk-table-hover uk-table-striped uk-table-condensed" 
                ></table>
                <script>$("#list-company-employees").DataTable({
                    dom: 't',
                    paginate: false,
                    order: [[ __DT_ORDERBY__, "asc" ]],
                    columns: [
                        { data:"is_active", title:(lang['__active.title__']||'__active.title__'), orderable:false, width:"1em", class:"uk-text-center", render: function(d,t,r){
                                var icon = d ? "uk-icon-user" : "uk-icon-user-times uk-text-muted";
                			    return '<a href="<?=URL_BASE?>ajax.php?f=__MODULE__/postToggle" data-toggle="is_active" data-post=\'{"id":"'+r.id+'"}\' data-trigger="employees-changed" class="'+icon+'"></a><span class="uk-hidden">'+d+"</span>";    
                        }   },
                        __DT_CE_PHOTO__
                ...
                <form action="<?=URL_BASE?>ajax.php?f=__MODULE__/companies_employees/postAddEmployee" data-trigger="employees-changed, company-updated">
                    <div class="uk-text-right uk-margin-top">
                        <input type="hidden" name="id">
                        <select class="select2"  name="id_employee" style="width:300px"
                            data-ajax--url="<?=URL_BASE?>ajax.php?f=__MODULE__/companies_employees/searchPartner" 
                            data-templateResult='{{id}}. __SEARCH_PHOTO__ {{text}} <br><small><i class="uk-icon-phone"></i> {{phone}} | <i class="uk-icon-envelope"></i> {{email}}</small>' 
        ...
        <div id="modal-remove-employee-from-company" class="uk-modal" data-hide-on-submit="true">
            <div class="uk-modal-dialog uk-modal-dialog-small"> <a class="uk-modal-close uk-close"></a>
                ...
                <form action="<?=URL_BASE?>ajax.php?f=__MODULE__/companies_employees/postRemoveEmployee" method="post" data-trigger="employees-changed,company-updated">
        ...
        <div id="modal-delete-company" class="uk-modal" data-hide-on-submit>
            <div class="uk-modal-dialog uk-modal-dialog-small"> <a class="uk-modal-close uk-close"></a>
                ...
                <form action="<?=URL_BASE?>ajax.php?f=__MODULE__/companies/postDelete" method="post" data-trigger="company-deleted">
