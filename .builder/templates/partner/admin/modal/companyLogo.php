  <?php /*** Modal image */?>
            <?php $s = parse_ini_file(INI_DIR.'__MODULE__/images.ini',true); $s=$s['company'];?>
            ...
            <div id="modal-company-logo" class="uk-modal" >
                <div class="uk-modal-dialog"> <a class="uk-modal-close uk-close"></a>
                    ...
                    <form action="<?=URL_BASE?>ajax.php?f=__MODULE__/companies/postImage" data-trigger="company-updated,company-changed-image">
                        <div class="uk-grid">
            ...
            <?php /*** Modal Tune Upload IMAGE */ ?>
             <div id="modal-tune-upload-logo" class="uk-modal no-ajax" data-hide-on-submit>
                <div class="uk-modal-dialog"> <a class="uk-modal-close uk-close"></a>
                    ...
                    <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=__MODULE__/companies/postImage" data-trigger="company-changed,company-changed-image" method="post">
