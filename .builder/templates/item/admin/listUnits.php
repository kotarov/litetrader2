...
<html class="uk-height-1-1">
    ...
    <body id="page-__MODULE__"> 
        ...
        <h2 class="page-header">__unit.title__</h2>
        ...
        <script> 
            $("#measure-units").DataTable({
            	...
            	ajax: "<?=URL_BASE?>ajax.php?f=__MODULE__/units/getUnits",
            	stateSave: true,
            	searching: false,
            	ordering: false,
            	columns: [
            	    { data:"is_default", title:(lang["Default"]||["Default"]), class:"uk-text-center", width:"1em", orderable:false,searchable:false,
            	        ...
            	        '<a href="<?=URL_BASE?>ajax.php?f=__MODULE__/units/postToggle" data-toggle="is_default" data-post=\'{"id":"'+r['id']+'"}\' data-trigger="units-changed" class="uk-icon-circle-thin uk-text-muted"></a>');        
            	    }},
        ...
        <?php /*** Modal NEW */ ?>
         <div id="modal-new-unit" class="uk-modal" data-hide-on-submit>
            <div class="uk-modal-dialog">
                ...
                <div class="uk-modal-header"> <h3 data-lang>New __unit.title__</h3> </div>
                <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=__MODULE__/units/postNew" data-trigger="units-changed">
         ...
         <div id="modal-edit-unit" class="uk-modal" data-hide-on-submit>
            <div class="uk-modal-dialog">
                ...
                <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=__MODULE__/units/postEdit" data-trigger="units-changed">
        ...
        <div id="modal-delete-unit" class="uk-modal" data-hide-on-submit>
            <div class="uk-modal-dialog uk-modal-dialog-small">  <a class="uk-modal-close uk-close"></a>
                ...
                <form action="<?=URL_BASE?>ajax.php?f=__MODULE__/units/postDelete" method="post" data-trigger="units-changed">
