    ...
    <body id="page-customers"> 
        ...
        <script> 
            $("#statuses").DataTable({
            	...
            	ajax: "<?=URL_BASE?>ajax.php?f=sales/statuses/getList",
            	stateSave: true,
            	order:[[2,'asc']],
            	columns: [
            		{ data:'is_default', title:"",width:"1em",orderable:false,searchable:false,"class":"uk-text-center uk-text-middle actions", render: function(d,t,r){
            		    return '<a href="<?=URL_BASE?>ajax.php?f=sales/statuses/postToggleDefault" data-post=\'{"id":"'+r.id+'"}\' data-toggle data-trigger="status-reload" '+(d==1?'class="uk-icon-play" title="Default">':'class="uk-text-muted" title="Make default">-')+'</a>';
            		}},
            		{ data:'is_closed', title:"", width:"1em",orderable:false, searchable:false, "class":"uk-text-center uk-text-middle actions", 
            		    render:function(d,t,r){ return '<a href="<?=URL_BASE?>ajax.php?f=sales/statuses/postToggle" data-post=\'{"id":"'+r.id+'"}\' data-toggle="is_closed" data-trigger="status-updated" '+(d?'class="uk-icon-lock"':'class="uk-icon-unlock uk-text-muted"')+'></a>';
            		}  },
        ...
        <?php /*** Modal NEW */ ?>
         <div id="modal-new-status" class="uk-modal" data-hide-on-submit>
            <div class="uk-modal-dialog"> <a class="uk-modal-close uk-close"></a>
                ...
                <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=sales/statuses/postNew" data-trigger="status-added">
                    ...
                    <div class="uk-form-row">
                        <div class="uk-form-controls">
                            <label><input type="checkbox" type="text" name="is_closed"> <span data-lang>This is closed status</span> </label>
                        </div>
                    </div> 
        ...
        <div id="modal-delete-status" class="uk-modal" data-hide-on-submit>
            <div class="uk-modal-dialog uk-modal-dialog-small">  <a class="uk-modal-close uk-close"></a>
                ...
                <form action="<?=URL_BASE?>ajax.php?f=sales/statuses/postDelete" method="post" data-trigger="status-deleted">
        ...
        <?php /*** Modal EDIT */ ?>
         <div id="modal-edit-status" class="uk-modal" data-get="<?=URL_BASE?>ajax.php?f=sales/statuses/getStatus" data-hide-on-submit>
            <div class="uk-modal-dialog"> <a class="uk-modal-close uk-close"></a>
                <div class="uk-modal-header"> <h3 data-lang>Edit status</h3> </div>
                <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=sales/statuses/postEdit" data-trigger="status-updated">
                    <input type="hidden" name="id">
                    <div class="uk-form-row">
                        <label class="uk-form-label">fa-Icon <span class="uk-text-danger">*</span></label>
                        <div class="uk-form-controls">
