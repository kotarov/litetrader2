...
<html class="uk-height-1-1">
    ...
    <body id="page-suppliers"> 
        ...
        <h2 class="page-header"><spn data-lang>Orders of Suppliers</span><span class="uk-margin-left page-sparkline" data-table="customers_orders"></span></h2>
        ...
        <script> 
            $("#orders").DataTable({
            	...
            	ajax: "<?=URL_BASE?>ajax.php?f=supplies/getList",
            	stateSave: true,
            	order: [[ 1, "desc" ]],
            	columns: [
            		...
            		{ data:"partner", title:(lang["Suppliers"]||"Suppliers"), render:function(d,t,r){return (r.id_partner>0?d:d+' <small class="uk-badge uk-badge-warning">Unregistered</small> ')} },
    ...
    return (d?d+un:'<i class="uk-icon-home"></i> ');
            	    ...
            	    { data:"actions", title:"", width:"1em", orderable:false, searchable:false, "class":"uk-text-center uk-text-middle uk-text-nowrap actions",
            			...
            			+'<a href="#modal-edit-order" data-uk-modal class="uk-icon-edit uk-icon-justify" data-get="id='+d+'" data-populate=\'{"id":"'+d+'","partner-photo":"../suppliers/image.php/'+r.id_partner+'","company-logo":"../suppliers/companies/image.php/'+r.id_company+'"}\' title="Edit"></a>'
        ...
        <?php /*** Modal NEW */ ?>
         <div id="modal-new-order" class="uk-modal" data-hide-on-submit>
            <div class="uk-modal-dialog uk-modal-dialog-medium"> <a class="uk-modal-close uk-close"></a>
                ...
                <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=supplies/post" data-trigger="order-added">
                    
                    <!-- ********* -->
                    <div class="uk-form-row">
                        <label class="uk-form-label"><span class="uk-badge uk-badge-notification">1</span> <span data-lang>Suppliers</span> </label>
                        <div class="uk-form-controls">
                            <select class="select2 uk-width-1-1" style="width:100%" 
                                name="id_partner" 
                                data-placeholder="UNREGISTERED" data-lang 
                                data-allow-clear= "true" 
                                data-ajax--url="<?=URL_BASE?>ajax.php?f=supplies/searchPartners" 
                                data-templateResult = '<span>
                                        {{id}}. <img src="<?=URL_BASE?>/suppliers/image.php/{{id}}/{{photo_date}}" width="40" class="uk-border-circle"> {{text}}
                                ...
                                data-templateSelection = '<span>{{id}}. <img src="<?=URL_BASE?>/suppliers/image.php/{{id}}/{{photo_date}}" width="20" class="uk-border-circle"> {{text}} <small>| <i class="uk-icon-envelope"></i> {{email}} | <i class="uk-icon-phone"></i> {{phone}}</small></span>' 
                            ></select>
                        </div>
                    </div>
                        ...
                        <div class="uk-form-row uk-margin-small-top">
                            ...
                            <div class="uk-form-controls">
                                <select class="select2 uk-width-1-1" style="width:100%" 
                                    ...
                                    data-placeholder="UNREGISTERED" data-lang
                                    data-allow-clear="true" 
                                    data-get="<?=URL_BASE?>ajax.php?f=supplies/getPartnerCompanies"
                    ...
                    <hr>
                        <div class="uk-form-row">
                            ...
                            <div class="uk-form-controls"><input class="uk-width-1-1"
                                ...
                                data-get="<?=URL_BASE?>ajax.php?f=supplies/getPartnerData&field=partner" 
                            ></div>
                        ...
                        <div class="uk-form-row uk-margin-top">
                            ...
                            <div class="uk-form-controls uk-grid">
                                <input class="uk-width-small-2-3" 
                                    ...
                                    data-depends-on="#modal-new-order [name=id_company],#modal-new-order [name=id_partner]" 
                                    data-get="<?=URL_BASE?>ajax.php?f=supplies/getPartnerData&field=name" 
                                >
                                <input class="uk-width-small-1-3" 
                                    placeholder="EIN" title="EIN" data-lang
                                    name="ein" 
                                    data-depends-on="#modal-new-order [name=id_company],#modal-new-order [name=id_partner]" 
                                    data-get="<?=URL_BASE?>ajax.php?f=supplies/getPartnerData&field=ein" 
                                >
                            </div>
                        ...
                        <div class="uk-form-row">
                            ...
                            <div class="uk-form-controls uk-grid">
                                <input class="uk-width-small-1-2"
                                    ...
                                    data-depends-on="#modal-new-order [name=id_company],#modal-new-order [name=id_partner]"
                                    data-get="<?=URL_BASE?>ajax.php?f=supplies/getPartnerData&field=email" 
                                >
                                <input name="phone" class="uk-width-small-1-2"
                                    placeholder="Phone" title="Phone" data-lang
                                    data-depends-on="#modal-new-order [name=id_company],#modal-new-order [name=id_partner]"
                                    data-get="<?=URL_BASE?>ajax.php?f=supplies/getPartnerData&field=phone" 
                                >
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="uk-form-row">
                            ...
                            <div class="uk-form-controls uk-grid">
                                <input type="text"  class="uk-width-small-1-2" data-lang 
                                    ...
                                    data-depends-on="#modal-new-order [name=id_company],#modal-new-order [name=id_partner]"
                                    data-get="<?=URL_BASE?>ajax.php?f=supplies/getPartnerData&field=country"  
                                >
                                ...
                                <input type="text" class="uk-width-small-1-2" data-lang 
                                    ...
                                    data-depends-on="#modal-new-order [name=id_company],#modal-new-order [name=id_partner]"
                                    data-get="<?=URL_BASE?>ajax.php?f=supplies/getPartnerData&field=city" 
                                >
                                ...
                                <input class="uk-width-small-1-1" data-lang 
                                    ...
                                    data-depends-on="#modal-new-order [name=id_company],#modal-new-order [name=id_partner]"
                                    data-get="<?=URL_BASE?>ajax.php?f=supplies/getPartnerData&field=address" 
                                >
                            </div>
                        </div>
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                                <label><input type="checkbox" class="toggle-color" name="register-new-partner"> <span data-lang>Suppliers</span> </label>
                        </div>
                        <div class="uk-form-controls">
        ...
        <?php /*** Modal EDIT */ ?>
         <div id="modal-edit-order" class="uk-modal" data-get="<?=URL_BASE?>ajax.php?f=supplies/getOrder" data-hide-on-submit>
            <div class="uk-modal-dialog uk-modal-dialog-medium"> <a class="uk-modal-close uk-close"></a>
                <div class="uk-modal-header"> <h3><span data-lang>Edit order</span> #<span name="id"></span></h3> </div>
                <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=supplies/post" data-trigger="order-updated">
                    ...
                    <div class="uk-form-row">
                        <label class="uk-form-label"><span data-lang>Suppliers</span> </label>
                        <div class="uk-form-controls">
                                    ...
                                    <select class="select2 uk-width-1-1" style="width:100%" 
                                        ...
                                        data-templateSelection = '<span>{{id}}. <img src="<?=URL_BASE?>/suppliers/image.php/{{id}}/{{photo_date}}" width="20" class="uk-border-circle"> {{text}}</span>' 
                                    ></select>
        ...
        <div id="modal-delete-order" class="uk-modal" data-hide-on-submit>
            <div class="uk-modal-dialog uk-modal-dialog-small">  <a class="uk-modal-close uk-close"></a>
                ...
                <form action="<?=URL_BASE?>ajax.php?f=supplies/postDelete" method="post" data-trigger="order-deleted" data-hide-on-submit>
        ...
        <div id="modal-change-status" class="uk-modal">
            <div class="uk-modal-dialog">  <a class="uk-modal-close uk-close"></a>
                ...
                <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=supplies/postStatus" data-trigger="ordercart-changed,order-updated">
                    <input type="hidden" name="id">                
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            <select class="select2 uk-width-1-1" style="width:100%" 
                                name="id_status"
                                data-get="<?=URL_BASE?>ajax.php?f=supplies/statuses/getList&first=%2B Change status ..." 
                ...
                <table id="list-order-statuses" data-trigger-reload="ordercart-changed" data-get="<?=URL_BASE?>ajax.php?f=supplies/statuses/getHistory" 
        ...
        <div id="modal-cart-order" class="uk-modal">
            <div class="uk-modal-dialog"> <a class="uk-modal-close uk-close"></a>
                ...
                <table id="list-orders-items" data-trigger-reload="order-cart-changed" data-get="<?=URL_BASE?>ajax.php?f=supplies/orders_items/getCart" class="uk-table uk-table-hover uk-table-striped uk-table-condensed" cellspacing="0" width="100%">
        ...
        <div id="modal-edit-from-cart" class="uk-modal" data-get="<?=URL_BASE?>ajax.php?f=supplies/orders_items/getEditItem" data-hide-on-submit>
            <div class="uk-modal-dialog"> <a class="uk-modal-close uk-close"></a>
                <div class="uk-modal-header"> <h3><span data-lang>Edit item in order</span> #<span name="id_parent"></span></h3> </div>
                <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=supplies/orders_items/postEditItem" data-trigger="order-cart-changed,order-updated">
        ...
        <div id="add-to-cart" class="uk-modal" data-hide-on-submit>
            <div class="uk-modal-dialog"> <a class="uk-modal-close uk-close"></a>
                ...
                <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=supplies/orders_items/postAppendCart" data-trigger="order-cart-changed,order-updated">
                    <input type="hidden" name="id_parent">
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            <select class="uk-width-1-1 select2" name="id_item" style="width:100%" 
                                data-ajax--url="<?=URL_BASE?>ajax.php?f=supplies/searchItems" 
                                data-templateResult='
        ...
        <?php /*** Modal delete from cart */?>
         <div id="modal-delete-from-cart" class="uk-modal" data-hide-on-submit>
            <div class="uk-modal-dialog uk-modal-dialog-small"> <a class="uk-modal-close uk-close"></a>
                ...
                <form action="<?=URL_BASE?>ajax.php?f=supplies/orders_items/postRemove" method="post" data-trigger="order-cart-changed,order-updated">
