...
<html class="uk-height-1-1">
    <head>
        ...
        <title>Companies of Suppliers</title>
    ...
    <body id="page-suppliers"> 
        ...
        <h2 class="page-header" data-lang="Companies of Suppliers"></h2>
        ...
        <script>$('#companies').DataTable({
        	...
        	ajax: "<?=URL_BASE?>ajax.php?f=suppliers/companies/getCompanies",
        	stateSave: true,
        	order: [[ 0, "asc" ]],
            columns: [
        ...
        <?php /*** Modal NEW */ ?>
         <div id="modal-new-company" class="uk-modal" data-hide-on-submit>
            <div class="uk-modal-dialog">
                ...
                <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=suppliers/companies/postNew" data-trigger="company-added">
        ...
        <?php /*** Modal EDIT */ ?>
         <div id="modal-edit-company" class="uk-modal" data-get="<?=URL_BASE?>ajax.php?f=suppliers/companies/getCompany" data-hide-on-submit>
            <div class="uk-modal-dialog">
                <a class="uk-modal-close uk-close"></a>
                <div class="uk-modal-header"> <h3><span data-lang>Edit company</span> #<span class="uk-text-muted" name="id"></span></h3> </div>
                <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=suppliers/companies/postEdit" data-trigger="company-updated">
        ...
        <div id="modal-company-employees" class="uk-modal">
            <div class="uk-modal-dialog"> <a class="uk-modal-close uk-close"></a>
                ...
                <table id="list-company-employees" cellspacing="0" width="100%" 
                    ...
                    data-get="<?=URL_BASE?>ajax.php?f=suppliers/companies_employees/getList" 
                ...
                <script>$("#list-company-employees").DataTable({
                    ...
                    columns: [
                        { data:"is_active", title:(lang['Active']||'Active'), orderable:false, width:"1em", class:"uk-text-center", render: function(d,t,r){
                			    ...
                			    return '<a href="<?=URL_BASE?>ajax.php?f=suppliers/postToggle" data-toggle="is_active" data-post=\'{"id":"'+r.id+'"}\' data-trigger="employees-changed" class="'+icon+'"></a><span class="uk-hidden">'+d+"</span>";    
                        }   },
                ...
                <form action="<?=URL_BASE?>ajax.php?f=suppliers/companies_employees/postAddEmployee" data-trigger="employees-changed, company-updated">
                    <div class="uk-text-right uk-margin-top">
                        <input type="hidden" name="id">
                        <select class="select2"  name="id_employee" style="width:300px"
                            data-ajax--url="<?=URL_BASE?>ajax.php?f=suppliers/companies_employees/searchPartner" 
        ...
        <div id="modal-remove-employee-from-company" class="uk-modal" data-hide-on-submit="true">
            <div class="uk-modal-dialog uk-modal-dialog-small"> <a class="uk-modal-close uk-close"></a>
                ...
                <form action="<?=URL_BASE?>ajax.php?f=suppliers/companies_employees/postRemoveEmployee" method="post" data-trigger="employees-changed,company-updated">
        ...
        <div id="modal-delete-company" class="uk-modal" data-hide-on-submit>
            <div class="uk-modal-dialog uk-modal-dialog-small"> <a class="uk-modal-close uk-close"></a>
                ...
                <form action="<?=URL_BASE?>ajax.php?f=suppliers/companies/postDelete" method="post" data-trigger="company-deleted">
          ...
          <?php /*** Modal image */?>
            <?php $s = parse_ini_file(INI_DIR.'suppliers/images.ini',true); $s=$s['company'];?>
            ...
            <div id="modal-company-logo" class="uk-modal" >
                <div class="uk-modal-dialog"> <a class="uk-modal-close uk-close"></a>
                    ...
                    <form action="<?=URL_BASE?>ajax.php?f=suppliers/companies/postImage" data-trigger="company-updated,company-changed-image">
                        <div class="uk-grid">
            ...
            <?php /*** Modal Tune Upload IMAGE */ ?>
             <div id="modal-tune-upload-logo" class="uk-modal no-ajax" data-hide-on-submit>
                <div class="uk-modal-dialog"> <a class="uk-modal-close uk-close"></a>
                    ...
                    <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=suppliers/companies/postImage" data-trigger="company-changed,company-changed-image" method="post">
                        <input type="hidden" name="id_parent">
