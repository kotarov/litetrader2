...
<html class="uk-height-1-1">
    ...
    <body id="page-suppliers"> 
        ...
        <h2 class="page-header"><span data-lang="Suppliers"></span> <span class="uk-margin-left page-sparkline" data-table="customers"></span></h2>
        ...
        <script> $('#partners').dataTable({
        	...
        	ajax: "<?=URL_BASE?>ajax.php?f=suppliers/getPartners",
        	stateSave: true,
        	order: [[ 2, "asc" ]],
            columns: [
                { data:"is_active", title: (lang['Active']||'Active'), width:"1em", class:"uk-text-center", render:function(d,t,r){
        			...
        			return '<a href="<?=URL_BASE?>ajax.php?f=suppliers/postToggle" data-post=\'{"id":"'+r.id+'"}\' data-toggle="is_active" data-trigger="partner-updated" class="'+icon+'"></a><span class="uk-hidden">'+d+"</span>";
        		}},
                { data:"is_advertise", title: (lang['Advertise']||'Advertise'), width:"1em", class:"uk-text-center", render:function(d,t,r){
        			...
        			return '<a href="<?=URL_BASE?>ajax.php?f=suppliers/postToggle" data-post=\'{"id":"'+r.id+'"}\' data-toggle="is_advertise" data-trigger="partner-updated" class="'+icon+'"></a><span class="uk-hidden">'+d+"</span>";
        		}},
    ...
    +'<img style="width:30px" class="uk-border-circle" src="image.php/'+r.id+'/'+r.photo_date+'"></a>';
        ...
        <?php /*** Modal NEW */ ?>
         <div id="modal-new-partner" class="uk-modal" data-hide-on-submit>
            <div class="uk-modal-dialog">
                ...
                <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=suppliers/postNew" data-trigger="partner-added">
                    ...
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            <select class="select2 uk-width-1-1" style="width:100%" 
                                ...
                                data-get="<?=URL_BASE?>ajax.php?f=suppliers/companies/getCompanies" 
        ...
        <?php /*** Modal EDIT */ ?>
         <div id="modal-edit-partner" class="uk-modal" data-get="<?=URL_BASE?>ajax.php?f=suppliers/getPartner" data-hide-on-submit>
            <div class="uk-modal-dialog">
                <a class="uk-modal-close uk-close"></a>
                <div class="uk-modal-header"> <h3><span data-lang>Edit</span> #<span class="uk-text-muted" name="id"></span></h3> </div>
                <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=suppliers/postEdit" data-trigger="partner-updated">
        ...
        <div id="modal-delete-partner" class="uk-modal" data-hide-on-submit>
            <div class="uk-modal-dialog uk-modal-dialog-small">  <a class="uk-modal-close uk-close"></a>
                ...
                <form action="<?=URL_BASE?>ajax.php?f=suppliers/postDelete" method="post" data-trigger="partner-deleted">
          ...
          <?php /*** Modal image */?>
            <?php $s = parse_ini_file(INI_DIR.'suppliers/images.ini',true); $s=$s['profile'];?>
            ...
            <div id="modal-image-partner" class="uk-modal" >
                <div class="uk-modal-dialog"> <a class="uk-modal-close uk-close"></a>
                    ...
                    <form action="<?=URL_BASE?>ajax.php?f=suppliers/postImage" data-trigger="partner-updated,partner-changed-image">
                        <div class="uk-grid">
            ...
            <?php /*** Modal Tune Upload IMAGE */ ?>
             <div id="modal-tune-upload-image" class="uk-modal no-ajax" data-hide-on-submit>
                <div class="uk-modal-dialog"> <a class="uk-modal-close uk-close"></a>
                    ...
                    <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=suppliers/postImage" data-trigger="partner-changed,partner-changed-image" method="post">
