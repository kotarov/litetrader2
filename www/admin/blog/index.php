        ...
        */?>
        ...
        <script> 
            $("#items").DataTable({
            	...
            	ajax: "<?=URL_BASE?>ajax.php?f=blog/getItems",
            	stateSave: true,
            	order: [[ 4, "desc" ]],
            	columns: [
            		
            		
            		{ data:"is_active", title:(lang["Act"]||"Act"), width:"1em", class:"uk-text-center", render:function(d,t,r){
            		    return '<a href="<?=URL_BASE?>ajax.php?f=blog/postToggleItem" class="uk-icon-eye'+(d?'':'-slash uk-text-muted')+'" data-toggle="is_active" data-trigger="item-updated" data-post=\'{"id":"'+r.id+'"}\'></a>';
            		}},
            		{ data:"is_advertise", title:"Ad", width:"1em", class:"uk-text-center", render: function(d,t,r){
            		    ...
            		    return '<a href="<?=URL_BASE?>ajax.php?f=blog/postToggleItem" data-trigger="item-updated" data-post=\'{"id":"'+r.id+'"}\' data-toggle="is_advertise" class="'+icon+'"><i hidden>'+d+'</i></a>';
            		}},
            		...
            		{ data:"title", title:(lang["Title"]||"Title")},
        ...
        <div>
            ...
            <div id="modal-new-item" class="uk-modal" data-hide-on-submit>
                <div class="uk-modal-dialog"> <a class="uk-modal-close uk-close"></a>
                    ...
                    <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=blog/postNewItem" data-trigger="item-added">
                            <div class="uk-form-row">
                                <label class="uk-form-label"><span data-lang>Title</span> <span class="uk-text-danger">*</span></label>
                                <div class="uk-form-controls"><input class="uk-width-1-1" type="text" name="title"></div>
                            </div>
                            
                            <div class="uk-form-row">
                                <label class="uk-form-label"><span data-lang>Subtitle</span>  <span class="uk-text-danger">*</span></label>
            ...
            <?php /*** Modal Edit */ ?>
            <div id="modal-edit-item" class="uk-modal" data-get="<?=URL_BASE?>ajax.php?f=blog/getItem" data-hide-on-submit>
                <div class="uk-modal-dialog"> <a class="uk-modal-close uk-close"></a>
                    <div class="uk-modal-header"> <h3><span data-lang>Edit item</span> #<span class="uk-text-muted" name="id"></span></h3> </div>
                    <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=blog/postEditItem" data-trigger="item-updated">
            ...
            <div id="modal-edit-item-content-re" class="uk-modal" data-get="<?=URL_BASE?>ajax.php?f=blog/getItemContent" data-hide-on-submit>
                <div class="uk-modal-dialog uk-modal-dialog-large uk-modal-dialog-lightbox">
                    ...
                    <form id="form-editor-item-content" class="uk-form" action="<?=URL_BASE?>ajax.php?f=blog/postItemContent" data-trigger="item-updated">
            ...
            <div id="modal-edit-item-content-script" class="uk-modal" data-get="<?=URL_BASE?>ajax.php?f=blog/getItemContent&forscript" data-hide-on-submit>
            ...
            <div id="modal-delete-item" class="uk-modal" data-hide-on-submit>
                <div class="uk-modal-dialog uk-modal-dialog-small"><a class="uk-modal-close uk-close"></a>
                    ...
                    <form action="<?=URL_BASE?>ajax.php?f=blog/postDeleteItem" method="post" data-trigger="item-deleted">
            ...
            <div id="modal-image-item" class="uk-modal">
                <div class="uk-modal-dialog"> <a class="uk-modal-close uk-close"></a>
                    ...
                    <table id="list-item-images" cellspacing="0" width="100%" 
                        ...
                        data-get="<?=URL_BASE?>ajax.php?f=blog/images/getImages" 
                    ...
                    <script>$("#list-item-images").DataTable({
                        ...
                        columns: [
                            { data: "is_cover", title:(lang["Cover"]||"Cover"), width:"1em", "class":"uk-text-center",orderable:false,render:function(d,t,r){
                                return '<a href="<?=URL_BASE?>ajax.php?f=blog/images/postUpdateCover" data-toggle data-post=\'{"id":"'+r['id']+'"}\' data-trigger="item-image-changed,item-updated" class="'+(d?"uk-icon-star":"uk-icon-star-o")+'"></a>';
                            }},
                    ...
                    <form id="form-product-upload-image" action="<?=URL_BASE?>ajax.php?f=blog/images/postImages" data-trigger="item-image-changed,item-updated">
                        <input type="hidden" name="id">
            ...
            <?php /*** Modal Tune Upload IMAGE */ ?>
             <div id="modal-tune-upload-image" class="uk-modal no-ajax" data-hide-on-submit>
                <div class="uk-modal-dialog"> <a class="uk-modal-close uk-close"></a>
                    ...
                    <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=blog/images/postImages" data-trigger="item-image-changed,item-updated" method="post">
            ...
            <div id="modal-delete-image" class="uk-modal" data-hide-on-submit>
                <div class="uk-modal-dialog uk-modal-dialog-small"> <a class="uk-modal-close uk-close"></a>
                    ...
                    <form action="<?=URL_BASE?>ajax.php?f=blog/images/postDelete" data-trigger="item-image-changed,item-updated">
            ...
            <script>
                $("#modal-image-item").on("click","[href='#dialog-preview-image']",function(e){ e.preventDefault();
                    ...
                    $.getJSON("<?=URL_BASE?>ajax.php?f=blog/images/getInfo&id="+id).done(function(ret){
                        console.log(ret);
