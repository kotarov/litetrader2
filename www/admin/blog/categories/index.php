...
<html class="uk-height-1-1">
    ...
    <body id="page-blog"> 
        ...
        <h2 class="page-header" data-lang>Blogs Category</h2>
        ...
        <script> 
            $("#categories").DataTable({
            	...
            	ajax: "<?=URL_BASE?>ajax.php?f=blog/categories/getCategories",
            	paginate: false,
            	stateSave: true,
            	searching: false,
            	ordering: false,
            	columns: [
            		{ data:"is_visible", title:(lang["Vis"]||"Vis"), width:"1em", class:"uk-text-center", render:function(d,t,r){
            		    return '<a href="<?=URL_BASE?>ajax.php?f=blog/categories/postToggleCategory" class="uk-icon-eye'+(d?'':'-slash uk-text-muted')+'" data-toggle="is_visible" data-trigger="category-changed" data-post=\'{"id":"'+r.id+'"}\'></a>';
            		}},
        ...
        <div>
            ...
            <div id="modal-new-category" class="uk-modal" data-hide-on-submit>
                <div class="uk-modal-dialog">
                    ...
                    <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=blog/categories/postNewCategory" data-trigger="category-changed">
                        ...
                        <div class="uk-form-row">
                            ...
                            <div class="uk-form-controls"><select data-get="<?=URL_BASE?>ajax.php?f=blog/categories/getCategories&getforselect" class="uk-width-1-1" name="id_parent"></select></div>
            ...
            <?php /*** Modal Edit */ ?>
            <div id="modal-edit-category" class="uk-modal" data-get="<?=URL_BASE?>ajax.php?f=blog/categories/getCategory" data-hide-on-submit>
                <div class="uk-modal-dialog">
                    <a class="uk-modal-close uk-close"></a>
                    <div class="uk-modal-header"> <h3><span data-lang>Edit category</span> #<span name="id"></span></h3> </div>
                    <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=blog/categories/postEditCategory" data-trigger="category-changed">
            ...
            <div id="modal-delete-category" class="uk-modal" data-hide-on-submit>
                <div class="uk-modal-dialog uk-modal-dialog-small">
                    ...
                    <form action="<?=URL_BASE?>ajax.php?f=blog/categories/postDeleteCategory" data-trigger="category-changed">
            ...
            <?php /*** Modal image */?>
            <?php $s = parse_ini_file(INI_DIR.'blog/images.ini',true); $s=$s['categories'];?>
            ...
            <div id="modal-image-category" class="uk-modal" >
                <div class="uk-modal-dialog uk-modal-dialog-large"> <a class="uk-modal-close uk-close"></a>
                    ...
                    <form action="<?=URL_BASE?>ajax.php?f=blog/categories/postImage" data-trigger="category-changed,category-changed-image">
                        <div class="uk-grid">
            ...
            <?php /*** Modal Tune Upload IMAGE */ ?>
             <div id="modal-tune-upload-image" class="uk-modal no-ajax" data-hide-on-submit>
                <div class="uk-modal-dialog"> <a class="uk-modal-close uk-close"></a>
                    ...
                    <form class="uk-form uk-form-horizontal" action="<?=URL_BASE?>ajax.php?f=blog/categories/postImage" data-trigger="category-changed,category-changed-image" method="post">
